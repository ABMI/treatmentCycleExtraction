...
execute<-function(connectionDetails,
  ...
  clusterApply(cluster, unique(primaryDrugExposure$subjectId), gapDateExamination, 
               primaryDrugExposure= primaryDrugExposure,
               secondaryDrugExposure = secondaryDrugExposure,
               drugInspectionDate =drugInspectionDate)
  
  data<-lapply(unique(primaryDrugExposure[[1]]$subjectId),function(i){gapDateExamination(subjectId = i)})
