...
where row_num = 1"
  ...
  if(length(excludingDrugConceptIdList$EXCLUDINGDRUG)!=0){excludingDrugConceptIdList <<- list(excludingDrugConceptIdList$EXCLUDINGDRUG)}else{excludingDrugConceptIdList <<- list()}
